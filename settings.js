...
module.exports = {
SESSION_ID: process.env.SESSION_ID ===VAJIRA-MD=zRtXjK6J#XIesM9FbjaIp-zaapJLBw4waKaWhLku-0ZhCxOmuqiI ? '' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === 25456535720 ? '' : process.env.OWNER_NUMBER,   
